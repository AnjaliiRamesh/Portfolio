...
//       <h2 className="text-2xl font-bold mb-4 dark:text-white">LeetCode Stats</h2>
//       <div className="grid grid-cols-3 gap-4">
//         <div className="p-4 bg-gray-100 dark:bg-gray-800 rounded-lg text-center">
//           <p className="text-xl font-bold dark:text-white">{stats.totalSolved}</p>
//           <p className="text-gray-600 dark:text-gray-400">Total</p>
//         </div>
//         <div className="p-4 bg-green-100 dark:bg-green-900 rounded-lg text-center">
//           <p className="text-xl font-bold dark:text-white">{stats.easySolved}</p>
//           <p className="text-gray-600 dark:text-gray-400">Easy</p>
//         </div>
//         <div className="p-4 bg-yellow-100 dark:bg-yellow-800 rounded-lg text-center">
//           <p className="text-xl font-bold dark:text-white">{stats.mediumSolved}</p>
//           <p className="text-gray-600 dark:text-gray-400">Medium</p>
//         </div>
//         <div className="p-4 bg-red-100 dark:bg-red-900 rounded-lg text-center col-span-3 mt-2">
//           <p className="text-xl font-bold dark:text-white">{stats.hardSolved}</p>
