...
//   return (
//     <div className="p-6 rounded-xl shadow-md bg-white dark:bg-[#1e1e1e] transition-colors">
//       <h2 className="text-2xl font-bold mb-4 dark:text-white">GitHub Profile</h2>
...
//         />
//         <div>
//           <p className="text-xl font-semibold dark:text-white">{profile.name}</p>
//           <a
